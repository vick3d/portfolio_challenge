...
const ProjectCard = (props) => {
    ...
    return (
        <div key={project.id} className="overflow-hidden border">
            <img src={project.image} className="block h-auto w-full" style ={{ height: '150px', objFit: 'cover' }} />
            ...
            <div className="flex items-center justify-between leading-none p-2 md:p4">
